        ...
        try {
            ...
            st=con.createStatement();
             ...
             st.executeUpdate("create table customer(id int,name varchar(200),mobileNumber varchar(10),nationality varchar(200), gender varchar(50),email varchar(200),idProof varchar(200),address varchar(500),checkIn varchar(50),roomNo varchar(10), bed varchar(200),roomType varchar(200),pricePerDay int,numberOfDaysStay int,totalAmount varchar(200),checkout varchar(50))");
              st.executeUpdate("create table staff(staffid int, staffname varchar(50),shift varchar(20),salary int)");
              st.executeUpdate("create table maintain(roomNo varchar(10), roomType varchar(200),bed varchar(200), status varchar(50))");
